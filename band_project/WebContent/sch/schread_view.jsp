...
<tr>
	<td bgcolor="black" width="20%"><font color = "white" FACE= "돋움">제목</font></td><td>${writing.title }</td>
</tr>
<tr>
	<td bgcolor="black" width="20%"><font color = "white"  FACE= "돋움">작성자</font></td><td>${writing.writerid }</td>
</tr>
<tr>
...
<tr>
	<td bgcolor="black" width="20%"><font color = "white"  FACE= "돋움">글내용</font></td><td>${writing.content }</td>
</tr>
<tr>
	<td bgcolor="black" width="20%"><font color = "white"  FACE= "돋움">장소</font></td><td>${writing.location }</td>
</tr>
<tr>
