...
<table class= "list" width="100%" height = "200%" cellpadding="0">
	...
	<c:if test="${ ! empty list }">
		...
		<tr class="sch"
			...
			<td onMouseover="this.bgColor='#FFFF6F',this.fontcolor='black';" onmouseout="this.bgColor='';"><font FACE="Geneva, TAHOMA" color="white" size="6">
						<a href="javascript:goView(${writing.writingid })" style="color: white">
			${writing.writingdate }</a></font></td>
			<td onMouseover="this.bgColor='#FFFF6F',this.fontcolor='black';" onmouseout="this.bgColor='';"><font FACE="Geneva, TAHOMA" color="white" size="5">
						<a href="javascript:goView(${writing.writingid })" style="color: white">
			${writing.writerid }</a></font></td>
			<td onMouseover="this.bgColor='#FFFF6F',this.fontcolor='black';" onmouseout="this.bgColor='';"><font FACE="Geneva, Nanum Gothic" color="white" size="4">
